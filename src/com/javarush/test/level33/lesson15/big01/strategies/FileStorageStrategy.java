...
public class FileStorageStrategy implements StorageStrategy {
    ...
    private FileBucket[] table =  {new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket(),new FileBucket()};
