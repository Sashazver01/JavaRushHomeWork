...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<StoryItem> wolfAte = new ArrayList<StoryItem>();
        wolfAte.add(hood);
        wolfAte.add(grandmother);
        wolf.ate = wolfAte;
        ArrayList<StoryItem> woodmanKill =  new ArrayList<StoryItem>();
        woodmanKill.add(wolf);
        woodman.killed = woodmanKill;
    }
