...
public class Client
{
    ...
    {
        ConsoleHelper.writeMessage("ведите адрес сервера");
    ...
    {
        ConsoleHelper.writeMessage("Введите никнейм");
        return ConsoleHelper.readString();
    }
    ...
    protected void sendTextMessage(String text)
    {
        ...
        {
            ConsoleHelper.writeMessage("Ошыбка отправки сообщения");
    ...
    public void run()
    {
        SocketThread socketThreadHelper = getSocketThread();
        socketThreadHelper.setDaemon(true);
        socketThreadHelper.start();
