...
//        Solution solution = new Solution("C:\\JavaRushHomeWork\\src\\com\\javarush\\test\\level36\\lesson10\\bonus01\\data\\second");
        Solution solution = new Solution("/home/alexandr/Idea/ArhivJavaRush/JavaRushHomeWork/src/com/javarush/test/level36/lesson10/bonus01/data/second");
        ...
        for (Class clazz : hiddenClasses) {
            ...
            if (clazz.getSimpleName().toLowerCase().startsWith(key.toLowerCase())) {
                ...
                try {
                    ...
                    Constructor needConstructor = null;
                    for (Constructor constructor : constructors) {
                        if (constructor.getParameterTypes().length == 0) {
                            needConstructor = constructor;
                        }

                    }
                    if (needConstructor!=null){
                        needConstructor.setAccessible(true);
                        return (HiddenClass) needConstructor.newInstance();
                    }
                    return null;
                } catch (Exception e) {
